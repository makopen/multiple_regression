...
st.title('Streamlit データ分析app')
st.header('回帰分析')


uploaded_file=st.file_uploader("csvファイルアップロード", type='csv')
use_example_file=st.checkbox('Use example file : wooldridge(wage1)',False,help="These are data from the 1976 Current Population Survey, collected by Henry Farber when he and I were colleagues at MIT in 1988. Data loads lazily.")
